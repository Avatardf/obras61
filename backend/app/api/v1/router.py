...
from app.api.v1 import auth, catalogo, centro_custo, conciliacao, dashboard, documentos, empreendimentos, equipes, financeiro, leads, obras, orcamentos, rdo, suprimentos, unidades, usuarios, vision
...
router.include_router(unidades.router)        # /empreendimentos/{id}/unidades — espelho digital
router.include_router(leads.router)           # /leads — funil de vendas (CRM)
