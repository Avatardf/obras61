...
from app.api.v1 import auth, catalogo, centro_custo, conciliacao, dashboard, documentos, empreendimentos, equipes, financeiro, obras, orcamentos, rdo, suprimentos, unidades, usuarios, vision
